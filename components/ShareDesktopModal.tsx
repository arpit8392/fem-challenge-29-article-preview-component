const ShareDesktopModal = () => {
	return (
		<div
			className='z-10 absolute mb-4 -translate-y-full translate-x-full ml-4'
			role='dialog'
			aria-modal={true}>
			<div className='relative hidden h-9 px-9 py-7 bg-darkGrayishBlue justify-between items-center rounded-xl shadow-xl md:flex'>
				<div className='absolute bottom-1 left-1/2 -translate-x-1/2 translate-y-1/2'>
					<div className='w-5 h-5 bg-darkGrayishBlue rotate-45 origin-bottom'></div>
				</div>
